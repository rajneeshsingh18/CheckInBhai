    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900 tracking-tight">Welcome to Rakshak</h1>
        ...
        <Card className="border-0 shadow-xl shadow-black/5 rounded-2xl">
          <CardContent className="pt-6">
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <Button
                type="submit"
                className="w-full bg-orange-600 hover:bg-orange-700 text-white shadow-lg shadow-orange-500/25 transition-all"
                disabled={isLoading}
              >
                {isLoading ? (
                  <>
            ...
            <div className="mt-6 flex items-center">
              ...
              <span className="flex-shrink-0 px-4 text-sm text-gray-400">or continue with</span>
              <div className="flex-grow border-t border-gray-200"></div>
            </div>
        ...
        <div className="text-center mt-6">
          <Link href="/guard-login" className="text-sm font-medium text-gray-500 hover:text-gray-900 transition-colors">
            Guard Login Portal &rarr;
          </Link>
        </div>
      </div>
    </div>
